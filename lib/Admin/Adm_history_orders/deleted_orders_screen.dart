...
class DeletedOrderAdmScreen extends StatefulWidget {
  const DeletedOrderAdmScreen({Key? key}) : super(key: key);

  @override
  _DeletedOrderAdmScreenState createState() => _DeletedOrderAdmScreenState();
}

class _DeletedOrderAdmScreenState extends State<DeletedOrderAdmScreen> {
   TextEditingController _textFieldController =TextEditingController();

  CollectionReference _referene =FirebaseFirestore.instance.collection("admin_deleted_orders");
 ...
 Widget _drawLowerBasicWidget(BuildContext context) {
    return  StreamBuilder(
      stream: _referene.orderBy("time", descending: true).snapshots(),
...
Widget  _drawHistoryContainerSeaerch(SearchHistoryModel searchResult) {
 return  Container(
    width: MediaQuery.of(context).size.width,
    height: MediaQuery.of(context).size.height*.23,
    child: Column(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.all(2),
                      child: Center(
                        child: Text(searchResult.number),
                      ),
                      width: MediaQuery.of(context).size.width*.333,
                      height: MediaQuery.of(context).size.height*.07,
                    ),
                ...
                child: Column(
                  children: [
                    Container(
                      padding: EdgeInsets.all(2),
                      child: Center(
                        child: Text(searchResult.paymentMethod),
                      ),
                      width: MediaQuery.of(context).size.width*.333,
                      height: MediaQuery.of(context).size.height*.07,
                    ),
                    Container(
                      padding: EdgeInsets.all(2),
                      child: Center(
                        child: Text(searchResult.wallet),
                      ),
                      width: MediaQuery.of(context).size.width*.333,
                      height: MediaQuery.of(context).size.height*.07,
                    ),
            ...
            Container(
                ...
                child: Column(
                  children: [
                    Container(
                      child: Center(
                        child: Text(searchResult.type  + " " + searchResult.useCode),
                      ),
                      padding: EdgeInsets.all(2),
                      width: MediaQuery.of(context).size.width*.333,
                      height: MediaQuery.of(context).size.height*.07,
